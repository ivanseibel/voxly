...
struct VoxlyConfig: Codable {
    ...
    private static let help: [String: String] = [
        ...
        "llamaContextSize": "Llama context window size in tokens. Prompts and refined output share it; a dictation whose prompts plus a viable output don't fit is inserted as raw text instead of being silently truncated.",
